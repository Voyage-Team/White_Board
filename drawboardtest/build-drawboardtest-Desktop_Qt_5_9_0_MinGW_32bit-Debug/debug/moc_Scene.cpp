...
void QScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QScene *_t = static_cast<QScene *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QScene::*_t)(const QJsonObject & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScene::addFigureReq)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QScene::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScene::deleteFigureReq)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QScene::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QScene::clearFigureReq)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_QScene.data,
      qt_meta_data_QScene,  qt_static_metacall, nullptr, nullptr}
};
