...
void NetConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NetConnect *_t = static_cast<NetConnect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NetConnect::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::joined)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (NetConnect::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::userLeft)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (NetConnect::*_t)(const QJsonObject & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::figureAdded)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (NetConnect::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::figureDeleted)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (NetConnect::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::figureCleared)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (NetConnect::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetConnect::errorOccured)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject NetConnect::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_NetConnect.data,
      qt_meta_data_NetConnect,  qt_static_metacall, nullptr, nullptr}
};
...
void *NetConnect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetConnect.stringdata0))
        return static_cast<void*>(const_cast< NetConnect*>(this));
